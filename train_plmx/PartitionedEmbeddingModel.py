...
class PartitionedEmbeddingModel(nn.Module):
    ...
    def apply_specialized_layers(self, known_subspace):
        ...
        modified_known[:, :20] *= self.coeff_0_20 
        modified_known[:, 20:23] *= self.coeff_20_23
        modified_known[:, 23:31] *= self.coeff_23_31
        modified_known[:, 31:32] *= self.coeff_31_32
        modified_known[:, 32:33] *= self.coeff_32_33
